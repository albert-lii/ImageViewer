package indi.liyi.viewer.progbr;
...
public class ProgressWheel extends View {
    ...
    public ProgressWheel(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.imgvr_ProgressWheel));
    }
    ...
    private void parseAttributes(TypedArray a) {
        barColor = a.getColor(R.styleable.imgvr_ProgressWheel_pwBarColor, barColor);
        barWidth = (int) a.getDimension(R.styleable.imgvr_ProgressWheel_pwBarWidth, barWidth);
        barLength = (int) a.getDimension(R.styleable.imgvr_ProgressWheel_pwBarLength, barLength);
        rimColor = a.getColor(R.styleable.imgvr_ProgressWheel_pwRimColor, rimColor);
        rimWidth = (int) a.getDimension(R.styleable.imgvr_ProgressWheel_pwRimWidth, rimWidth);
        contourColor = a.getColor(R.styleable.imgvr_ProgressWheel_pwContourColor, contourColor);
        contourSize = a.getDimension(R.styleable.imgvr_ProgressWheel_pwContourSize, contourSize);
        circleColor = a.getColor(R.styleable.imgvr_ProgressWheel_pwCircleColor, circleColor);

        // Only set the text if it is explicitly defined
        if (a.hasValue(R.styleable.imgvr_ProgressWheel_pwText)) {
            setText(a.getString(R.styleable.imgvr_ProgressWheel_pwText));
        }
        textColor = a.getColor(R.styleable.imgvr_ProgressWheel_pwTextColor, textColor);
        textSize = (int) a.getDimension(R.styleable.imgvr_ProgressWheel_pwTextSize, textSize);

        spinSpeed = a.getFloat(R.styleable.imgvr_ProgressWheel_pwSpinSpeed, spinSpeed);
        delayMillis = a.getInteger(R.styleable.imgvr_ProgressWheel_pwDelayMillis, delayMillis);
        if (delayMillis < 0) {
            delayMillis = 10;
        }
        a.recycle();
